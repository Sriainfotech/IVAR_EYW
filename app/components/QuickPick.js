...
const picks = [...bowls, ...cafe].slice(0, 8);
  ...
  return (
    <section className="max-w-[1320px] mx-auto px-[6vw] py-14 md:py-20">
      <div className="text-center mb-8">
        <p className="text-[11px] tracking-[0.24em] font-bold text-ivar-coral uppercase mb-2">Order in seconds</p>
        <h2 className="font-extrabold text-3xl md:text-[40px] text-ivar-dark">Quick Pick</h2>
        <div className="inline-flex mt-6 bg-ivar-mint rounded-full p-1">
          {[
            ["quick", "Quick Pick"],
            ["sub", "Subscription"],
          ].map(([id, label]) => (
      ...
      <div className="text-center mt-10">
        <Link
          href="/shop"
          className="inline-block bg-ivar-dark text-white font-semibold text-sm rounded-full px-8 py-3.5 hover:bg-ivar-green transition-colors"
        >
          View full menu
        </Link>
      </div>
